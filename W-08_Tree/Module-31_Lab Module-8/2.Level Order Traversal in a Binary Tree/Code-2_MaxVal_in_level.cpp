...
int levelOrderTraversal(treeNode *root, string &chk, int k)
{
   ...
   // guess as a lowest maximum value
   int max = -9999;
   ...
   while (!q.empty())
   {
      ...
      if (chkNode != NULL)
      {
         ...
         chk += to_string(chkNode->data); // To return  as a string and print at last.But it's Not necessary
...
int main()
{
   ...
   // To find K level maximum value
   int max = levelOrderTraversal(allNodes[0], levelordertraversal, 2);
