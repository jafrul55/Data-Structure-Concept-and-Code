...
treeNode *buildTreePreANDIn(int preOrder[], int inOrder[], int start, int end)
{
    ...
    newNode->leftChild = buildTreePreANDIn(preOrder, inOrder, start, pos - 1);
    newNode->rightChild = buildTreePreANDIn(preOrder, inOrder, pos + 1, end);
...
int main()
{
    ...
    treeNode *root = buildTreePreANDIn(preOrder, inOrder, 0, n - 1);
    string chkPre = "";
