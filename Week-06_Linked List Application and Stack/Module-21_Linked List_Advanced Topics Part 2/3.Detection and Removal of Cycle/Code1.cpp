...
//Make A Cycle At Kth Position Part1:
void makeCycle(Node* &head,int pos)
{
  ...
  //Overide using startNode in the temp->next
  temp->Next = startNode;
  
}
// To find the circle  is available or not:
...
void removeCycle(Node* &head)
{
   ...
   //Step 1: fast == slow
   //use here do-while loop cause first do then check:
   do
   {
      slow = slow->Next;
      fast=fast->Next->Next;
...
int main()
{
    ...
    cout << "Choice 1:Insertion at Head" << endl
         ...
         << "Choice 13:Make A Cycle At Kth Position"<<endl
         << "Choice 14:Detect Cycle in the List"<<endl
         << "Remove a Cycle (If any)"<<endl
         << "Choice 0:Exit" << endl
         << endl;
    cout << "Next Choice: ";
    int choice;
